...
- `skills/add-3d-models/references/model-catalog.md` — 5,700+ optimized 3D models with descriptions, dimensions, animations, and R2 download URLs (generated by `catalog-builder` pipeline)
